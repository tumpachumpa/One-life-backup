...
const itemsData = _require('../data/items.json');
const classesData = _require('../data/classes.json');
const enemiesData = _require('../data/enemies.json');
const bossesData = _require('../data/bosses.json');
const petsData = _require('../data/pets.json');
const zonesData = _require('../data/zones.json');
const talentsData = _require('../data/talents.json');
const adventuresData = _require('../data/adventures.json');
const equipmentGenerationData = _require('../data/equipmentGeneration.json');
